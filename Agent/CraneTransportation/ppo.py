...
class CTAgent:
    def __init__(self, meta_data,  # 그래프 구조에 대한 정보
        ...
        self.network = CTScheduler(meta_data=meta_data,
        ...
        self.scheduler = OneCycleLR(self.optimizer, max_lr=0.0001, steps_per_epoch=1, epochs=2000, anneal_strategy='linear')
